...
<template>
 <section class="course-management">
  ...
  <form class="admin-filters" @submit.prevent="search">
   <label class="admin-filter-field course-title-filter"><span>标题</span><el-input v-model="filters.search" aria-label="筛选标题" placeholder="输入课程标题或唯一 ID" clearable @clear="search"><template #prefix><Search :size="16"/></template></el-input></label>
