...
export const presets = [
 ...
 {key:'rights_changed',name:'会员权限变更',group:'account',groups:['rights'],title:'{{exam_name}}会员权限已更新',body:'当前会员权限：{{membership_permission}}。请进入我的权益查看详情。',route:'rights',help:'已记录的权益发生变化时发送，包括权益到期恢复普通会员和后台人工调整。'},
 {key:'rights_expiring',name:'会员权限到期提醒',group:'account',groups:['rights'],title:'{{exam_name}}会员权限即将调整',body:'当前{{membership_permission}}有效至{{membership_expire_time}}。VIP、SVIP到期后均恢复普通会员。',route:'rights',help:'到期前7天、1天各发一次。'},
