...
.route-view{margin-top:20rpx}.route-hero{display:flex;align-items:center;justify-content:space-between;gap:16rpx;padding:18rpx;color:#fff;background:#273a63;border:1rpx solid #41547d;border-radius:11rpx;box-shadow:0 10rpx 24rpx rgba(34,50,87,.16)}.route-hero-copy{display:flex;min-width:0;flex-direction:column;gap:5rpx}.view-kicker{color:#e4bf67;font-size:var(--sxb-text-meta);font-weight:700}.view-title{font-size:var(--sxb-text-title);font-weight:700}.route-subtitle{max-width:245rpx;overflow:hidden;color:#c7d1e5;font-size:var(--sxb-text-meta);text-overflow:ellipsis;white-space:nowrap}.route-ring{--progress:0deg;width:77rpx;height:77rpx;display:flex;align-items:center;justify-content:center;flex:none;background:conic-gradient(#e4bf67 var(--progress),rgba(255,255,255,.13) 0);border-radius:50%}.route-ring>view{width:62rpx;height:62rpx;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:2rpx;background:#273a63;border-radius:50%}.route-ring text:first-child{font-size:var(--sxb-text-small);font-weight:700}.route-ring text:last-child{color:#c7d1e5;font-size:var(--sxb-text-meta)}.subject-switch{display:grid;grid-template-columns:repeat(2,1fr);gap:8rpx;margin-top:13rpx}.subject-switch button{height:45rpx;line-height:43rpx;margin:0;padding:0;color:#64748a;background:#fff;border:1rpx solid #dce3ed;border-radius:7rpx;font-size:var(--sxb-text-small);font-weight:700}.subject-switch button.active{color:#315fae;background:#edf3ff;border-color:#aac1ef}.subject-switch button::after,.chapter-track button::after,.filter-bar button::after,.section-heading button::after,.route-point::after,.point-expanded button::after,.route-empty button::after{display:none}.chapter-scroll{width:100%;margin-top:10rpx;white-space:nowrap}.chapter-track{display:inline-flex;gap:8rpx}.chapter-track button{width:205rpx;height:55rpx;display:flex;align-items:flex-start;justify-content:center;flex-direction:column;gap:3rpx;margin:0;padding:0 11rpx;color:#617087;background:#fff;border:1rpx solid #dfe5ed;border-radius:7rpx;text-align:left}.chapter-track text:first-child{color:#486188;font-size:var(--sxb-text-meta);font-weight:700}.chapter-track text:last-child{width:100%;overflow:hidden;font-size:var(--sxb-text-meta);text-overflow:ellipsis;white-space:nowrap}.chapter-track button.active{color:#fff;background:#40557d;border-color:#40557d}.chapter-track button.active text:first-child{color:#e2e8f4}.route-summary{display:grid;grid-template-columns:repeat(3,1fr);margin-top:13rpx;padding:13rpx 3rpx;background:#fff;border:1rpx solid #dfe5ed;border-radius:9rpx}.route-summary view{display:flex;align-items:center;flex-direction:column;gap:3rpx;border-right:1rpx solid #e5e9ef}.route-summary view:last-child{border-right:0}.route-summary text:first-child{color:#293e5d;font-size:var(--sxb-text-body);font-weight:700}.route-summary text:last-child{color:#8592a3;font-size:var(--sxb-text-meta)}.filter-bar{display:flex;gap:7rpx;margin-top:11rpx}.filter-bar button{width:auto;height:38rpx;line-height:36rpx;margin:0;padding:0 12rpx;color:#6e7d91;background:#edf1f6;border-radius:7rpx;font-size:var(--sxb-text-meta)}.filter-bar button.active{color:#fff;background:#6949df;font-weight:700}.learning-route{margin-top:15rpx}.route-section{display:grid;grid-template-columns:37rpx 1fr;gap:9rpx}.route-axis{display:flex;align-items:center;flex-direction:column}.axis-node{position:relative;z-index:1;width:29rpx;height:29rpx;display:flex;align-items:center;justify-content:center;color:#546985;background:#eef2f8;border:2rpx solid #a9b7ca;border-radius:50%;font-size:var(--sxb-text-meta);font-weight:700}.axis-node.done{color:#fff;background:#1a9a7b;border-color:#1a9a7b}.axis-line{width:2rpx;min-height:60rpx;flex:1;background:#d8e0eb}.route-section:last-child .axis-line{background:linear-gradient(#d8e0eb,transparent)}.route-content{min-width:0;padding-bottom:16rpx}.section-heading{min-height:29rpx;display:flex;align-items:center;justify-content:space-between;gap:10rpx}.section-heading>view{display:flex;min-width:0;flex-direction:column;gap:3rpx}.section-heading>view text:first-child{color:#6949df;font-size:var(--sxb-text-meta);font-weight:700}.section-heading>view text:last-child{overflow:hidden;color:#243750;font-size:var(--sxb-text-body);font-weight:700;text-overflow:ellipsis;white-space:nowrap}.section-heading>button{width:auto;height:34rpx;display:flex;align-items:center;gap:3rpx;flex:none;margin:0;padding:0 9rpx;color:#40577a;background:#edf2f8;border-radius:6rpx;font-size:var(--sxb-text-meta);font-weight:700}.route-points{display:flex;flex-direction:column;gap:8rpx;margin-top:9rpx}.route-point{width:100%;min-height:75rpx;display:flex;align-items:flex-start;gap:10rpx;margin:0;padding:12rpx;color:#34465f;background:#fff;border:1rpx solid #dfe5ed;border-radius:8rpx;text-align:left;box-shadow:0 5rpx 12rpx rgba(45,66,104,.04)}.route-point.expanded{border-color:#a9bde3;box-shadow:0 0 0 2rpx rgba(87,111,166,.08)}.point-state{width:24rpx;height:24rpx;display:flex;align-items:center;justify-content:center;flex:none;margin-top:2rpx;background:#edf1f6;border-radius:50%}.route-point.mastered .point-state{background:#1a9a7b}.point-content{display:flex;flex:1;min-width:0;flex-direction:column;gap:5rpx}.point-head{display:flex;align-items:center;justify-content:space-between;gap:8rpx}.point-head text:first-child{padding:2rpx 6rpx;color:#a76816;background:#fff2df;border-radius:4rpx;font-size:var(--sxb-text-meta);font-weight:700}.point-head text:last-child{color:#8290a2;font-size:var(--sxb-text-meta)}.point-title{color:#2c405b;font-size:var(--sxb-text-small);line-height:1.5;font-weight:700}.point-expanded{padding-top:9rpx;border-top:1rpx solid #e8ecf2}.point-expanded>text{display:block;color:#68788d;font-size:var(--sxb-text-meta);line-height:1.6}.point-expanded>view{display:flex;align-items:center;justify-content:space-between;margin-top:9rpx;color:#8b97a7;font-size:var(--sxb-text-meta)}.point-expanded button{width:auto;height:32rpx;display:flex;align-items:center;gap:2rpx;margin:0;padding:0 3rpx;color:#3569e8;background:transparent;font-size:var(--sxb-text-meta);font-weight:700}.route-empty{min-height:230rpx;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:9rpx;margin-top:14rpx;color:#8a97a8;background:#fff;border:1rpx solid #dfe5ed;border-radius:10rpx;font-size:var(--sxb-text-meta)}.route-empty button{width:auto;height:38rpx;line-height:36rpx;margin:4rpx 0 0;padding:0 12rpx;color:#6949df;background:#f1effc;border-radius:6rpx;font-size:var(--sxb-text-meta);font-weight:700}
.subject-switch { flex-wrap: nowrap; overflow-x: auto; }
.subject-switch button { flex-shrink: 0; height: 36px; line-height: 34px; white-space: nowrap; }
.point-title, .point-expanded > text { font-size: 14px; }
.section-heading > view { min-width: 0; }
.section-heading > view text:last-child { white-space: normal; line-height: 1.5; }
.section-heading button { flex: none; }
.point-expanded button { min-height: 36px; }
.route-ring { width: 68px; height: 68px; }
.route-ring > view { width: 56px; height: 56px; }
.route-ring text:last-child { white-space: nowrap; }
.filter-bar button { height: 32px; line-height: 30px; padding: 0 10px; }
.section-heading > button { min-height: 32px; }
</style>

<style lang="scss" scoped>
.chapter-scroll{height:58px}.chapter-track button{width:160px;height:58px;padding:0 10px;gap:4px;line-height:1.3}.chapter-track text:first-child{font-size:var(--sxb-text-meta);line-height:1.3}.chapter-track text:last-child{font-size:var(--sxb-text-body);line-height:1.5}
</style>
