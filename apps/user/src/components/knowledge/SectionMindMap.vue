...
.mind-map-view{margin-top:20rpx}.map-overview{display:flex;align-items:center;justify-content:space-between;gap:16rpx}.map-overview>view:first-child{display:flex;flex-direction:column;gap:4rpx}.view-kicker{color:#6949df;font-size:var(--sxb-text-meta);font-weight:700}.view-title{color:#182a43;font-size:var(--sxb-text-title);font-weight:700}.overview-count{min-width:76rpx;padding:9rpx 12rpx;display:flex;align-items:flex-end;justify-content:center;gap:4rpx;color:#7c899c;background:#fff;border:1rpx solid #dfe5ee;border-radius:8rpx}.overview-count text:first-child{color:#273d60;font-size:var(--sxb-text-item);line-height:1;font-weight:700}.overview-count text:last-child{font-size:var(--sxb-text-meta)}.subject-tabs{width:100%;margin-top:16rpx;white-space:nowrap}.tab-row{display:inline-flex;gap:8rpx}.tab-row button{width:auto;height:44rpx;line-height:42rpx;margin:0;padding:0 14rpx;color:#617087;background:#fff;border:1rpx solid #dce3ed;border-radius:7rpx;font-size:var(--sxb-text-small);font-weight:700}.tab-row button.active{color:#fff;background:#293d67;border-color:#293d67}.tab-row button::after,.selector-row button::after,.mind-node::after,.detail-actions button::after{display:none}.selector-block{margin-top:13rpx;padding:12rpx;background:#fff;border:1rpx solid #dfe5ee;border-radius:10rpx}.selector-scroll{width:100%;white-space:nowrap}.selector-row{display:inline-flex;gap:8rpx}.selector-row button{width:210rpx;height:55rpx;display:flex;align-items:flex-start;justify-content:center;flex-direction:column;gap:3rpx;margin:0;padding:0 11rpx;color:#5f7087;background:#f6f8fb;border:1rpx solid #e5e9f0;border-radius:7rpx;text-align:left}.selector-row button text:first-child{font-size:var(--sxb-text-meta);font-weight:700}.selector-row button text:last-child{width:100%;overflow:hidden;font-size:var(--sxb-text-meta);text-overflow:ellipsis;white-space:nowrap}.selector-row button.active{color:#315fae;background:#edf3ff;border-color:#a9c2f1}.section-scroll{margin-top:9rpx}.section-row button{width:auto;max-width:320rpx;height:39rpx;display:block;line-height:37rpx;padding:0 11rpx;overflow:hidden;font-size:var(--sxb-text-meta);text-overflow:ellipsis;white-space:nowrap}.section-row button.active{color:#6949df;background:#f1effc;border-color:#c9c0ef}.mind-canvas{position:relative;min-height:300rpx;margin-top:14rpx;padding:18rpx 12rpx 18rpx 190rpx;overflow:hidden;background:#f7f9fd;border:1rpx solid #dce4ef;border-radius:12rpx}.mind-canvas::before{position:absolute;left:174rpx;top:0;bottom:0;width:1rpx;content:'';background:#d9e2f1}.mind-root{position:absolute;z-index:2;left:13rpx;top:50%;width:145rpx;min-height:112rpx;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:4rpx;padding:12rpx 10rpx;color:#fff;background:#273a63;border:4rpx solid #dce5f7;border-radius:12rpx;transform:translateY(-50%);box-shadow:0 10rpx 22rpx rgba(37,54,94,.2)}.root-icon{width:32rpx;height:32rpx;display:flex;align-items:center;justify-content:center;background:rgba(255,255,255,.12);border-radius:8rpx}.mind-root>text:nth-child(2){color:#bfcbea;font-size:var(--sxb-text-meta);font-weight:700}.mind-root>text:nth-child(3){display:-webkit-box;overflow:hidden;font-size:var(--sxb-text-meta);line-height:1.35;text-align:center;font-weight:700;-webkit-box-orient:vertical;-webkit-line-clamp:2}.root-progress{width:100%;height:4rpx;margin-top:3rpx;overflow:hidden;background:rgba(255,255,255,.16);border-radius:4rpx}.root-progress view{height:100%;background:#e4bf67}.branch-stack{display:flex;flex-direction:column;gap:10rpx}.mind-branch{position:relative;display:flex;align-items:center}.branch-line{position:absolute;left:-17rpx;width:17rpx;height:2rpx;background:#bdcbe2}.branch-line span{position:absolute;right:-3rpx;top:-3rpx;width:8rpx;height:8rpx;background:#8ba5d1;border:2rpx solid #f7f9fd;border-radius:50%}.mind-node{width:100%;min-height:98rpx;display:flex;align-items:stretch;justify-content:center;flex-direction:column;gap:6rpx;margin:0;padding:11rpx 12rpx;color:#34465f;background:#fff;border:1rpx solid #d9e2ee;border-left:5rpx solid #3569e8;border-radius:9rpx;text-align:left;box-shadow:0 5rpx 12rpx rgba(45,66,104,.05)}.mind-node.selected{border-color:#879fd0;box-shadow:0 0 0 2rpx rgba(77,105,169,.12),0 8rpx 16rpx rgba(45,66,104,.09)}.mind-node.star-4{border-left-color:#6949df}.mind-node.star-5{border-left-color:#d89a35}.node-head,.node-foot{display:flex;align-items:center;justify-content:space-between;gap:8rpx}.node-head text:first-child{color:#6f7f95;font-size:var(--sxb-text-meta);font-weight:700}.node-head text:last-child{padding:2rpx 6rpx;color:#6949df;background:#f1effc;border-radius:4rpx;font-size:var(--sxb-text-meta);font-weight:700}.star-5 .node-head text:last-child{color:#b46c16;background:#fff2df}.node-title{display:-webkit-box;overflow:hidden;color:#263b57;font-size:var(--sxb-text-small);line-height:1.4;font-weight:700;-webkit-box-orient:vertical;-webkit-line-clamp:2}.node-foot{color:#8a96a6;font-size:var(--sxb-text-meta)}.map-empty{min-height:240rpx;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:10rpx;margin-top:14rpx;color:#8b98a9;background:#fff;border:1rpx solid #dfe5ee;border-radius:11rpx;font-size:var(--sxb-text-small)}.node-detail{margin-top:14rpx;padding:17rpx;background:#fff;border:1rpx solid #dfe5ee;border-radius:11rpx;box-shadow:0 7rpx 18rpx rgba(45,66,104,.05)}.detail-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12rpx}.detail-head>view{display:flex;flex:1;min-width:0;flex-direction:column;gap:5rpx}.detail-label{color:#6949df;font-size:var(--sxb-text-meta);font-weight:700}.detail-title{color:#24374f;font-size:var(--sxb-text-body);line-height:1.45;font-weight:700}.detail-star{flex:none;padding:4rpx 8rpx;color:#a76816;background:#fff2df;border-radius:5rpx;font-size:var(--sxb-text-meta);font-weight:700}.detail-summary{display:-webkit-box;overflow:hidden;margin-top:10rpx;color:#66768b;font-size:var(--sxb-text-small);line-height:1.65;-webkit-box-orient:vertical;-webkit-line-clamp:3}.detail-stats{display:grid;grid-template-columns:repeat(3,1fr);margin-top:14rpx;padding:12rpx 0;background:#f6f8fb;border-radius:8rpx}.detail-stats view{display:flex;align-items:center;flex-direction:column;gap:4rpx;border-right:1rpx solid #e2e7ee}.detail-stats view:last-child{border-right:0}.detail-stats text:first-child{color:#2e4261;font-size:var(--sxb-text-small);font-weight:700}.detail-stats text:last-child{color:#8a96a6;font-size:var(--sxb-text-meta)}.detail-actions{display:flex;gap:9rpx;margin-top:14rpx}.detail-actions button{height:48rpx;display:flex;align-items:center;justify-content:center;gap:4rpx;flex:1;margin:0;padding:0;color:#40577a;background:#edf2f8;border-radius:7rpx;font-size:var(--sxb-text-meta);font-weight:700}.detail-actions button.primary{color:#fff;background:#3569e8}
.tab-row button { height: 36px; line-height: 34px; }
.node-title, .detail-summary { font-size: 14px; }
.detail-actions button { min-height: 40px; }
.node-head, .node-foot { flex-wrap: wrap; }
</style>

<style lang="scss" scoped>
.selector-scroll{height:58px}.section-scroll{height:40px}.selector-row button{width:160px;height:58px;padding:0 10px;gap:4px;line-height:1.3}.selector-row button text:first-child{font-size:var(--sxb-text-meta);line-height:1.3}.selector-row button text:last-child{font-size:var(--sxb-text-body);line-height:1.5}.section-row button{width:auto;max-width:260px;height:40px;line-height:38px;padding:0 10px;font-size:var(--sxb-text-small)}.node-title{font-size:var(--sxb-text-body);line-height:1.5}.node-foot{font-size:var(--sxb-text-meta)}
</style>
