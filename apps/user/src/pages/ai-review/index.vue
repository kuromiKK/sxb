...
.top-bar>text { color:#1d1b17; font-size:27rpx; font-weight:900; text-align:center; }
...
.service-mark { height:38rpx; display:flex; align-items:center; gap:6rpx; box-sizing:border-box; padding:0 10rpx; color:#1b1811; background:linear-gradient(120deg,#e4c36c,#f4dfa0); border-radius:5rpx; font-size:15rpx; font-weight:900; }
.hero-head>button { width:auto; height:43rpx; display:flex; align-items:center; justify-content:center; gap:5rpx; margin:0; padding:0 12rpx; color:#efd586; background:rgba(231,201,114,.08); border:1rpx solid rgba(231,201,114,.42); border-radius:7rpx; font-size:17rpx; font-weight:800; }
.hero-title { margin-top:22rpx; }
.hero-title>text { display:block; }
.hero-title>text:first-child { color:#f7e9c2; font-size:29rpx; line-height:1.35; font-weight:900; }
.hero-title>text:last-child { max-width:94%; margin-top:8rpx; color:#f3dca4; font-size:18rpx; line-height:1.55; }
...
.hero-data text:first-child { color:#e6ba62; font-size:34rpx; line-height:1; font-weight:900; }
.hero-data text:last-child { color:#f3dca4; font-size:17rpx; }
.hero-foot { margin-top:15rpx; }
.hero-foot>text { color:#e2d8bf; font-size:18rpx; font-weight:700; }
.hero-foot button { width:auto; height:43rpx; display:flex; align-items:center; justify-content:center; gap:5rpx; margin:0; padding:0 13rpx; color:#1c1810; background:linear-gradient(120deg,#dfbd60,#f2db96); border-radius:7rpx; font-size:18rpx; font-weight:900; }
...
.selection-head>view text:first-child { color:#211f1a; font-size:24rpx; font-weight:900; }
.selection-head>view text:last-child { color:#8b8374; font-size:17rpx; }
.selection-head>text { color:#9c7625; font-size:18rpx; font-weight:800; }
.filter-segments { display:grid; grid-template-columns:repeat(4,1fr); gap:7rpx; margin-top:15rpx; }
.filter-segments>view { height:58rpx; display:flex; align-items:center; justify-content:center; gap:5rpx; color:#6d675c; background:#f1eee7; border:1rpx solid transparent; border-radius:7rpx; font-size:18rpx; }
.filter-segments>view>text:last-child { min-width:25rpx; color:#989080; font-size:15rpx; text-align:center; }
.filter-segments>view.active { color:#f2d783; background:#1b1a17; border-color:#5e512e; font-weight:900; }
...
.note-type { display:inline-block; padding:2rpx 7rpx; color:#8a681f; background:#f7eed2; border-radius:4rpx; font-size:15rpx; font-weight:850; }
.note-title,.note-excerpt { display:block; overflow:hidden; white-space:nowrap; text-overflow:ellipsis; }
.note-title { margin-top:5rpx; color:#292720; font-size:21rpx; line-height:1.5; font-weight:850; }
.note-excerpt { margin-top:4rpx; color:#858075; font-size:17rpx; }
...
.button-count text:first-child { font-size:35rpx; line-height:1; font-weight:900; }
.button-count text:last-child { font-size:17rpx; font-weight:750; }
.button-action { display:flex; align-items:center; justify-content:center; gap:6rpx; min-width:0; }
.button-action text { font-size:21rpx; font-weight:900; }
...
.result-hero>view:last-child text:first-child { color:#fff8e8; font-size:26rpx; font-weight:900; }
.result-hero>view:last-child text:last-child { color:#cfc5ae; font-size:18rpx; }
...
.report-title text:first-child { color:#242119; font-size:26rpx; font-weight:900; }
.report-title text:last-child { color:#918877; font-size:17rpx; }
...
.report-stats text:first-child { color:#9c7420; font-size:25rpx; font-weight:900; }
.report-stats text:last-child { color:#756d5e; font-size:16rpx; }
.report-section { margin-top:21rpx; padding-top:19rpx; border-top:1rpx solid #e9e3d7; }
.report-section>text:first-child { display:block; color:#28241b; font-size:23rpx; font-weight:900; }
.report-section>text:nth-child(2) { display:block; margin-top:9rpx; color:#5f594f; font-size:19rpx; line-height:1.72; }
.report-section>view { display:flex; flex-direction:column; gap:8rpx; margin-top:12rpx; }
.report-section>view>text { position:relative; padding-left:18rpx; color:#686154; font-size:18rpx; line-height:1.55; }
...
.export-actions button { height:59rpx; display:flex; align-items:center; justify-content:center; gap:6rpx; margin:0; color:#8b631a; background:#f7efd8; border:1rpx solid #ead9a9; border-radius:8rpx; font-size:19rpx; font-weight:900; }
...
.result-actions button { height:62rpx; margin:0; color:#7d5b15; background:#f5ecd1; border-radius:8rpx; font-size:20rpx; font-weight:900; }
...
.sheet-head>view text:first-child { color:#fff7e5; font-size:26rpx; font-weight:900; }
.sheet-head>view text:last-child { color:#a99f89; font-size:17rpx; }
...
.history-list>view>view:nth-child(2) text:first-child { overflow:hidden; color:#f3ecd9; font-size:20rpx; font-weight:850; white-space:nowrap; text-overflow:ellipsis; }
.history-list>view>view:nth-child(2) text:last-child { color:#a79d88; font-size:16rpx; }
.history-empty { padding:58rpx 0; color:#a79d88; font-size:18rpx; text-align:center; }
...
.exchange-dialog>text:nth-child(2) { margin-top:15rpx; color:#fff6df; font-size:26rpx; font-weight:900; }
.exchange-dialog>text:nth-child(3) { margin-top:10rpx; color:#bbb19c; font-size:18rpx; line-height:1.65; text-align:center; }
.exchange-dialog button { width:100%; height:58rpx; margin:20rpx 0 0; color:#1a1710; background:linear-gradient(120deg,#d8b655,#efd68c); border-radius:8rpx; font-size:19rpx; font-weight:900; }
</style>
