...
.notice-page{max-width:430px;min-height:100vh;margin:0 auto;box-sizing:border-box;padding-top:calc(env(safe-area-inset-top) + 18rpx);padding-bottom:48rpx;background:#f5f7fb}.notice-top{height:58rpx;display:flex;align-items:center;justify-content:space-between}.notice-top>button{width:58rpx;height:58rpx;display:flex;align-items:center;justify-content:center;margin:0;padding:0;background:#fff;border:1rpx solid #e1e7f0;border-radius:14rpx}.notice-top>button::after{display:none}.notice-top>text{color:#20334b;font-size:25rpx;font-weight:900}.notice-top>view{width:58rpx}.notice-heading{display:flex;flex-direction:column;gap:6rpx;margin-top:29rpx}.notice-heading>text:first-child{color:#17263c;font-size:36rpx;font-weight:950}.notice-heading>text:last-child{color:#7d899a;font-size:20rpx}.notice-count{display:flex;align-items:center;gap:7rpx;margin-top:20rpx;padding:13rpx 14rpx;color:#6556a7;background:#f1effc;border:1rpx solid #e0dcf6;border-radius:9rpx;font-size:18rpx}.notice-list{overflow:hidden;margin-top:14rpx;background:#fff;border:1rpx solid #dfe5ed;border-radius:12rpx}.notice-item{display:block;padding:20rpx 18rpx;border-bottom:1rpx solid #e9edf3}.notice-title{display:block;color:#24364f;font-size:24rpx;line-height:1.45;font-weight:900}.notice-intro{display:-webkit-box;overflow:hidden;margin-top:9rpx;color:#65758a;font-size:20rpx;line-height:1.65;-webkit-box-orient:vertical;-webkit-line-clamp:3}.notice-meta{display:flex;align-items:center;justify-content:space-between;gap:12rpx;margin-top:13rpx}.notice-meta>text{color:#939dac;font-size:17rpx}.notice-meta>button{width:auto;height:37rpx;display:flex;align-items:center;gap:2rpx;line-height:37rpx;margin:0;padding:0 4rpx;color:#6949df;background:transparent;font-size:17rpx;font-weight:800}.notice-meta>button::after{display:none}.notice-more{width:100%;height:58rpx;display:flex;align-items:center;justify-content:center;gap:6rpx;margin:0;padding:0;color:#5b50b9;background:#f2f0ff;border:0;border-top:1rpx solid #ded9fb;border-radius:0;font-size:19rpx;font-weight:850}.notice-more text:nth-child(2){color:#8c81c6;font-size:16rpx;font-weight:600}.notice-more::after{display:none}.notice-end{display:flex;align-items:center;gap:11rpx;padding:20rpx 18rpx;color:#9aa4b2;font-size:17rpx}.notice-end span{height:1rpx;flex:1;background:#e4e8ee}
</style>
