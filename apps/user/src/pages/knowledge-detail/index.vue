...
.detail-page { max-width: 430px; min-height: 100vh; margin: 0 auto; box-sizing: border-box; padding: calc(env(safe-area-inset-top) + 18rpx) 20px 42rpx; background: #f5f7fb; }.detail-top { display: flex; align-items: center; justify-content: space-between; height: 58rpx; }.back-button,.favorite-button { width: 58rpx; height: 58rpx; display: flex; align-items: center; justify-content: center; margin: 0; padding: 0; background: #edf1fb; border: 0; border-radius: 15rpx; }.back-button::after,.favorite-button::after { display: none; }.favorite-button { background: #fff; border: 1rpx solid #e0e6f0; }.favorite-button.active { background: #fff4e6; border-color: #f8d5a7; }.detail-top-title { color: #1e3048; font-size: 25rpx; font-weight: 850; }.crumb { display: flex; align-items: center; gap: 4rpx; margin-top: 18rpx; overflow: hidden; color: #8b96a5; font-size: 17rpx; white-space: nowrap; }.crumb text { overflow: hidden; text-overflow: ellipsis; }.point-hero { margin-top: 17rpx; padding: 22rpx; color: #fff; background: linear-gradient(135deg,#1d3558 0%,#3a4b93 100%); border-radius: 15rpx; box-shadow: 0 12rpx 26rpx rgba(43,58,113,.18); }.hero-top { display: flex; align-items: flex-start; gap: 12rpx; }.hero-icon { width: 48rpx; height: 48rpx; display: flex; align-items: center; justify-content: center; flex: none; background: rgba(255,255,255,.14); border-radius: 13rpx; }.hero-title-wrap { flex: 1; min-width: 0; }.hero-title { display: block; color: #fff; font-size: 25rpx; line-height: 1.5; font-weight: 850; }.hero-tags { display: flex; align-items: center; gap: 7rpx; margin-top: 9rpx; }.star-tag,.mastery-tag { display: inline-block; padding: 4rpx 8rpx; border-radius: 5rpx; font-size: 17rpx; line-height: 1.25; font-weight: 850; }.star-tag { color: #d47a25; background: #fff2df; }.mastery-tag { color: #d8e4ff; background: rgba(255,255,255,.12); }.hero-stats { display: grid; grid-template-columns: repeat(3,1fr); margin-top: 20rpx; padding-top: 17rpx; border-top: 1rpx solid rgba(255,255,255,.15); }.hero-stats view { display: flex; flex-direction: column; align-items: center; gap: 4rpx; border-right: 1rpx solid rgba(255,255,255,.14); }.hero-stats view:last-child { border-right: 0; }.hero-stats text:first-child { font-size: 29rpx; font-weight: 850; }.hero-stats text:last-child { color: #becbe2; font-size: 17rpx; }.content-card,.note-card { margin-top: 16rpx; padding: 19rpx; background: #fff; border: 1rpx solid #e0e6f0; border-radius: 13rpx; box-shadow: 0 7rpx 19rpx rgba(51,74,115,.04); }.card-title-row { display: flex; align-items: center; justify-content: space-between; gap: 8rpx; }.card-title { display: flex; align-items: center; gap: 8rpx; color: #22354e; font-size: 22rpx; font-weight: 850; }.title-bar { width: 5rpx; height: 24rpx; background: #3569e8; border-radius: 5rpx; }.title-bar.orange { background: #e98a3a; }.content-hint { color: #a0aaba; font-size: 17rpx; }.content-text { display: block; margin-top: 15rpx; color: #4b5c72; font-size: 21rpx; line-height: 1.75; }.key-line { display: flex; align-items: flex-start; gap: 6rpx; margin-top: 14rpx; padding: 10rpx 11rpx; color: #8a622b; background: #fff8ed; border-radius: 7rpx; font-size: 19rpx; line-height: 1.45; }.course-card { display: flex; align-items: center; gap: 11rpx; margin-top: 16rpx; padding: 16rpx; background: #f0edff; border: 1rpx solid #ded7ff; border-radius: 12rpx; }.course-icon { width: 43rpx; height: 43rpx; display: flex; align-items: center; justify-content: center; flex: none; background: #fff; border-radius: 11rpx; }.course-copy { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: 3rpx; }.course-label { color: #7969c5; font-size: 17rpx; }.course-title { overflow: hidden; color: #3e347f; font-size: 21rpx; font-weight: 800; white-space: nowrap; text-overflow: ellipsis; }.course-meta { color: #8378b4; font-size: 17rpx; }.note-card textarea { width: 100%; min-height: 170rpx; box-sizing: border-box; margin-top: 15rpx; padding: 13rpx; color: #34475f; background: #fafbfe; border: 1rpx solid #e3e8f1; border-radius: 9rpx; font-size: 21rpx; line-height: 1.6; }.note-placeholder { color: #a1acba; }.note-footer { display: flex; align-items: center; justify-content: space-between; margin-top: 11rpx; color: #a1aaba; font-size: 17rpx; }.save-note { width: 124rpx; height: 42rpx; display: flex; align-items: center; justify-content: center; gap: 4rpx; margin: 0; padding: 0; color: #fff; background: #3569e8; border-radius: 7rpx; font-size: 17rpx; font-weight: 750; }.save-note::after { display: none; }.save-note.saved { background: #1a9a7b; }.detail-tip { display: flex; align-items: flex-start; gap: 6rpx; margin-top: 17rpx; padding: 11rpx 12rpx; color: #64758b; background: #edf3ff; border-radius: 8rpx; font-size: 17rpx; line-height: 1.45; }
...
.extension-title text:first-child { color:#22354e; font-size:22rpx; font-weight:850; }
.extension-title text:last-child { color:#99a4b3; font-size:16rpx; }
...
.extension-copy text:first-child { color:#2a3c54; font-size:21rpx; font-weight:850; }
...
.practice-copy-head text:last-child { color:#3569e8; font-size:17rpx; font-weight:850; }
.practice-copy .practice-meta { overflow:hidden; color:#7f8c9d; font-size:17rpx; font-weight:400; text-overflow:ellipsis; white-space:nowrap; }
...
.extension-copy text:last-child { overflow:hidden; color:#7f8c9d; font-size:17rpx; text-overflow:ellipsis; white-space:nowrap; }
...
.point-navigation button { height:62rpx; display:flex; align-items:center; justify-content:center; gap:6rpx; margin:0; padding:0 12rpx; border-radius:9rpx; font-size:20rpx; font-weight:850; }
