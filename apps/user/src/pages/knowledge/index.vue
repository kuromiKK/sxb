...
.knowledge-header { display: flex; align-items: flex-start; justify-content: space-between; gap: 16rpx; }.header-copy { display: flex; flex-direction: column; gap: 6rpx; }.eyebrow { color: #6949df; font-size: var(--sxb-text-small); font-weight: 700; letter-spacing: 0; }.page-title { color: #152238; font-size: var(--sxb-text-page); font-weight: 700; }.header-sub { color: #7b8797; font-size: var(--sxb-text-body); }.exam-countdown { display: flex; flex-direction: column; align-items: flex-end; gap: 3rpx; margin-top: 8rpx; padding: 9rpx 12rpx; color: #718096; background: #fff6eb; border: 1rpx solid #f7dfbd; border-radius: 9rpx; white-space: nowrap; }.exam-countdown > text:first-child { font-size: var(--sxb-text-meta); }.exam-countdown > view { display: flex; align-items: baseline; gap: 3rpx; color: #d47a25; }.countdown-days { font-size: var(--sxb-text-title); line-height: 1; font-weight: 700; }
.mode-switch { display: flex; gap: 6rpx; margin-top: 24rpx; padding: 5rpx; background: #e9edf6; border-radius: 11rpx; }.mode-item { flex: 1; height: 58rpx; display: flex; align-items: center; justify-content: center; gap: 6rpx; color: #7e8a9c; border-radius: 8rpx; font-size: var(--sxb-text-body); font-weight: 700; }.mode-item.active { color: #3569e8; background: #fff; box-shadow: 0 4rpx 12rpx rgba(54,76,125,.08); }
.guide-line { display: flex; align-items: flex-start; gap: 9rpx; margin-top: 16rpx; padding: 12rpx 14rpx; color: #5e6e87; background: #edf3ff; border: 1rpx solid #dce8ff; border-radius: 9rpx; font-size: var(--sxb-text-small); line-height: 1.5; }.guide-icon { width: 28rpx; height: 28rpx; display: flex; align-items: center; justify-content: center; flex: none; }
.subject-list { display: flex; flex-direction: column; gap: 14rpx; margin-top: 18rpx; }.subject-panel { overflow: hidden; background: #fff; border: 1rpx solid #dfe6f0; border-radius: 13rpx; box-shadow: 0 8rpx 22rpx rgba(51,74,115,.04); }.subject-header { display: flex; align-items: center; gap: 12rpx; padding: 18rpx; }.subject-mark { width: 48rpx; height: 48rpx; display: flex; align-items: center; justify-content: center; flex: none; border-radius: 13rpx; }.subject-copy { flex: 1; min-width: 0; }.subject-name { display: block; color: #152238; font-size: var(--sxb-text-body); font-weight: 700; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }.subject-meta { display: flex; gap: 13rpx; margin-top: 6rpx; color: #7d8999; font-size: var(--sxb-text-small); }.subject-progress { height: 6rpx; margin-top: 9rpx; overflow: hidden; background: #edf0f6; border-radius: 6rpx; }.subject-progress view { height: 100%; border-radius: 6rpx; }.subject-toggle { width: 28rpx; height: 34rpx; display: flex; align-items: center; justify-content: center; flex: none; }.subject-body { border-top: 1rpx solid #eef1f5; padding: 0 16rpx 10rpx; }.chapter-group { border-bottom: 1rpx solid #eff2f6; }.chapter-group:last-child { border-bottom: 0; }.chapter-header { display: flex; align-items: center; justify-content: space-between; gap: 8rpx; padding: 18rpx 2rpx 13rpx; }.chapter-label { display: flex; align-items: baseline; gap: 8rpx; min-width: 0; }.chapter-label text:first-child { color: #3569e8; font-size: var(--sxb-text-small); font-weight: 700; flex: none; }.chapter-label text:last-child { color: #24364f; font-size: var(--sxb-text-body); font-weight: 700; }.chapter-body { padding-bottom: 6rpx; }.section-group { overflow: hidden; margin: 0 0 10rpx; background: #f8faff; border: 1rpx solid #e7edf7; border-radius: 10rpx; }.section-header { display: flex; align-items: center; justify-content: space-between; gap: 8rpx; padding: 13rpx 13rpx; }.section-header>view { display: flex; align-items: baseline; gap: 8rpx; min-width: 0; }.section-header text:first-child { color: #6949df; font-size: var(--sxb-text-meta); font-weight: 700; flex: none; }.section-header text:last-child { color: #30425c; font-size: var(--sxb-text-body); font-weight: 700; }.point-list { border-top: 1rpx solid #e6ebf4; background: #fff; }.point-row { display: flex; align-items: flex-start; gap: 9rpx; padding: 14rpx 13rpx; border-bottom: 1rpx solid #edf0f5; }.point-row:last-child { border-bottom: 0; }.point-main { flex: 1; min-width: 0; }.point-title { display: block; color: #24364f; font-size: var(--sxb-text-body); line-height: 1.5; }.point-meta { display: flex; align-items: center; flex-wrap: wrap; gap: 9rpx; margin-top: 8rpx; color: #8b96a5; font-size: var(--sxb-text-meta); }.star-tag { padding: 2rpx 7rpx; border-radius: 5rpx; font-size: var(--sxb-text-meta); line-height: 1.3; font-weight: 700; }.star-1 { color: #6f7e91; background: #eef1f5; }.star-2 { color: #3d78b9; background: #eaf3ff; }.star-3 { color: #3569e8; background: #eaf0ff; }.star-4 { color: #6949df; background: #f0edff; }.star-5 { color: #d47a25; background: #fff2df; }
...
.point-title { font-size: var(--sxb-text-body); line-height: 1.65; }
