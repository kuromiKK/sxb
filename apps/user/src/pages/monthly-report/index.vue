...
.report-page{--report-device-scale:1;--report-content-shift:30px;--report-chapter-margin:15.72px;--report-qr-margin:106.72px;--report-nav-padding:34px;--report-nav-button:45px;--report-share-width:160.73px;--report-share-gap:11px;--report-share-offset:110px;--report-summary-height:110px;--report-summary-text:13.8px;width:var(--report-width,100%);max-width:430px;min-height:var(--report-height,100vh);margin:0 auto;box-sizing:border-box;padding:calc(env(safe-area-inset-top) + 18rpx) 20px 48rpx;background:#111827;color:#edf1f6}.report-page.device-iphone14pro,.report-page.device-iphone15promax{height:var(--report-height);overflow-y:auto}.report-top{height:58rpx;display:flex;align-items:center;justify-content:space-between}.report-top button{width:58rpx;height:58rpx;display:flex;align-items:center;justify-content:center;margin:0;padding:0;background:#202a3b;border-radius:14rpx}.report-top button::after{display:none}.report-top text{font-size:var(--sxb-text-item);font-weight:700}.report-top>view{width:58rpx}.report-hero{margin-top:19rpx;padding:22rpx;background:linear-gradient(125deg,#2b3948,#171d34 58%,#292052);border:1rpx solid #414a5b;border-radius:13rpx;box-shadow:0 16rpx 34rpx rgba(0,0,0,.25)}.hero-label{display:flex;justify-content:space-between;color:#d6b562;font-size:var(--sxb-text-meta);font-weight:700}.hero-label text:last-child{color:#8995a7;font-weight:500}.hero-month{display:block;margin-top:19rpx;color:#e2c476;font-size:var(--sxb-text-heading);font-weight:700}.hero-headline{display:block;margin-top:8rpx;color:#c9d0dc;font-size:var(--sxb-text-small);line-height:1.55}.hero-metrics{display:grid;grid-template-columns:repeat(2,1fr);gap:9rpx;margin-top:20rpx}.hero-metrics view{display:flex;flex-direction:column;gap:4rpx;padding:13rpx;background:rgba(255,255,255,.06);border:1rpx solid rgba(255,255,255,.08);border-radius:8rpx}.hero-metrics text:first-child{color:#e2c476;font-size:var(--sxb-text-item);font-weight:700}.hero-metrics text:last-child{color:#9da8b8;font-size:var(--sxb-text-meta)}.report-section{margin-top:14rpx;padding:18rpx;background:#1a2232;border:1rpx solid #303a4c;border-radius:11rpx}.section-heading{display:flex;align-items:flex-start;justify-content:space-between;gap:10rpx}.section-heading>view{display:flex;flex-direction:column;gap:4rpx}.section-heading>view text:first-child{color:#edf0f5;font-size:var(--sxb-text-body);font-weight:700}.section-heading>view text:last-child{color:#7f8b9d;font-size:var(--sxb-text-meta)}.section-heading>text{color:#d6b562;font-size:var(--sxb-text-meta);font-weight:700}.daily-chart{height:150rpx;display:flex;align-items:flex-end;gap:3rpx;margin-top:18rpx;border-bottom:1rpx solid #394354}.day-bar{height:100%;display:flex;align-items:center;justify-content:flex-end;flex:1;flex-direction:column}.day-bar>view{width:100%;min-height:2rpx;background:#53607a;border-radius:2rpx 2rpx 0 0}.day-bar>view.peak{background:#d6b562}.day-bar text{height:20rpx;margin-top:5rpx;color:#69768a;font-size:var(--sxb-text-meta)}.chart-legend{display:flex;justify-content:space-between;margin-top:7rpx;color:#768397;font-size:var(--sxb-text-meta)}.subject-chart{margin-top:17rpx}.subject-row{display:grid;grid-template-columns:74rpx 1fr 70rpx;align-items:center;gap:8rpx;margin-top:13rpx;color:#aeb8c7;font-size:var(--sxb-text-meta)}.subject-row>view{height:11rpx;background:#353f52;border-radius:10rpx}.total-bar{height:100%;background:#77525a;border-radius:10rpx}.total-bar>view{height:100%;background:#596b9e;border-radius:10rpx}.subject-row>text:last-child{text-align:right}.subject-legend{display:flex;justify-content:flex-end;gap:15rpx;margin-top:13rpx;color:#7f8b9d;font-size:var(--sxb-text-meta)}.subject-legend text{display:flex;align-items:center;gap:5rpx}.subject-legend i{width:9rpx;height:9rpx;background:#77525a;border-radius:2rpx}.subject-legend i.correct{background:#596b9e}.chapter-list{margin-top:15rpx}.chapter-list>view{margin-top:13rpx}.chapter-list>view>view:first-child{display:flex;justify-content:space-between;color:#b7c0ce;font-size:var(--sxb-text-meta)}.chapter-list>view>view:first-child text:last-child{color:#d6b562}.chapter-list .weak{color:#d47b78!important;background:#b75e62!important}.chapter-list>view>view:last-child{height:8rpx;margin-top:7rpx;background:#313b4d;border-radius:8rpx}.chapter-list>view>view:last-child>view{height:100%;background:linear-gradient(90deg,#53688d,#d6b562);border-radius:8rpx}.tool-stats{display:grid;grid-template-columns:repeat(2,1fr);gap:9rpx;margin-top:16rpx}.tool-stats>view{display:flex;flex-direction:column;gap:4rpx;padding:13rpx;background:#202a3b;border-radius:8rpx}.tool-stats>view>text:first-child{color:#d6b562;font-size:var(--sxb-text-item);font-weight:700}.tool-stats small{margin-left:3rpx;font-size:var(--sxb-text-meta)}.tool-stats>view>text:nth-child(2){color:#c0c8d4;font-size:var(--sxb-text-meta);font-weight:700}.tool-stats>view>text:last-child{color:#748196;font-size:var(--sxb-text-meta)}.summary-group{margin-top:17rpx;padding:14rpx;background:#202a3a;border-left:4rpx solid #d6b562;border-radius:6rpx}.summary-group>text{color:#d6b562;font-size:var(--sxb-text-meta);font-weight:700}.summary-group>view{display:flex;align-items:flex-start;gap:8rpx;margin-top:10rpx;color:#b4becd;font-size:var(--sxb-text-meta);line-height:1.55}.summary-group i{width:7rpx;height:7rpx;flex:none;margin-top:8rpx;background:#d6b562;border-radius:50%}.summary-group.concern{border-left-color:#b75e62}.summary-group.concern>text{color:#cf7c7f}.summary-group.concern i{background:#b75e62}.summary-group.next{border-left-color:#6679ad}.summary-group.next>text{color:#91a0cf}.summary-group.next i{width:23rpx;height:23rpx;display:flex;align-items:center;justify-content:center;margin-top:0;color:#cbd4ed;background:#4f608d;border-radius:50%;font-size:var(--sxb-text-meta);font-style:normal}.report-actions{display:grid;grid-template-columns:1fr 1fr;gap:10rpx;margin-top:17rpx}.report-actions button{height:58rpx;display:flex;align-items:center;justify-content:center;gap:6rpx;margin:0;padding:0;color:#d6b562;background:#202a3b;border:1rpx solid #5d543d;border-radius:9rpx;font-size:var(--sxb-text-small);font-weight:700}.report-actions button:last-child{color:#1c2437;background:#d6b562;border-color:#d6b562}.report-actions button::after{display:none}.privacy-tip{display:block;margin-top:12rpx;color:#657286;font-size:var(--sxb-text-meta);text-align:center}.poster-canvas{position:fixed;left:-10000px;width:540px;height:800px}
...
.report-page:not(.multi-page) {
  line-height: 1.6;
  .hero-label { flex-wrap: wrap; gap: 4px 12px; }
  .hero-label text:last-child { color: #aeb8c7; }
  .hero-month { font-size: 24px; }
  .hero-headline, .summary-group > view { font-size: 14px; }
  .hero-metrics text:first-child, .tool-stats > view > text:first-child { font-size: 22px; }
  .report-section { padding: 16px; margin-top: 14px; }
  .section-heading > view text:first-child { font-size: 16px; }
  .section-heading > view text:last-child, .chart-legend, .subject-legend, .tool-stats > view > text:last-child, .privacy-tip { color: #aeb8c7; }
  .daily-chart { height: 120px; padding-bottom: 24px; }
  .day-bar { position: relative; }
  .day-bar text { position: absolute; top: 100%; color: #aeb8c7; }
  .subject-row { grid-template-columns: 84px minmax(0, 1fr) 60px; gap: 8px; }
  .chapter-list > view > view:first-child { gap: 8px; }
  .chapter-list > view > view:first-child text:last-child { flex: none; }
  .summary-group.next i { width: 22px; height: 22px; }
  .report-actions button { min-height: 44px; }
}
.report-top { min-height: 44px; }
.report-top text, .multi-page .report-top > text { font-size: 16px; font-weight: 600; }
.report-top button { min-width: 44px; min-height: 44px; }
</style>
