...
<style lang="scss">
.session-page { max-width: 430px; min-height: 100vh; margin: 0 auto; box-sizing: border-box; padding-top: calc(env(safe-area-inset-top) + 16rpx); padding-bottom: calc(110px + env(safe-area-inset-bottom)); background: #f5f7fb; }.session-top { display: flex; align-items: center; justify-content: space-between; min-height: 58rpx; }.back-button,.favorite-button { width: 58rpx; height: 58rpx; display: flex; align-items: center; justify-content: center; margin: 0; padding: 0; background: #edf1fb; border-radius: 15rpx; }.favorite-button { background: #fff; border: 1rpx solid #e0e6f0; }.favorite-button.active { background: #fff4e6; border-color: #f8d5a7; }.back-button::after,.favorite-button::after { display: none; }.top-title { display: flex; align-items: center; flex: 1; min-width: 0; flex-direction: column; gap: 3rpx; }.top-title text:first-child { color: #1e3048; font-size: 25rpx; font-weight: 900; }.top-title text:last-child { overflow: hidden; max-width: 240rpx; color: #8a96a5; font-size: 15rpx; text-overflow: ellipsis; white-space: nowrap; }.progress-head { display: flex; align-items: center; justify-content: space-between; margin-top: 18rpx; color: #536783; font-size: 19rpx; }.progress-head text:first-child { color: #30425c; font-weight: 850; }.progress-head text:last-child { color: #3569e8; font-weight: 850; }.progress-track { height: 7rpx; margin-top: 8rpx; overflow: hidden; background: #e3e9f2; border-radius: 7rpx; }.progress-track view { height: 100%; background: linear-gradient(90deg,#3569e8,#7655df); border-radius: 7rpx; }.question-params { display: flex; align-items: center; flex-wrap: wrap; gap: 7rpx; margin-top: 18rpx; }.question-params text { padding: 5rpx 9rpx; color: #3569e8; background: #eaf0ff; border-radius: 6rpx; font-size: 17rpx; font-weight: 800; }.question-params text:nth-child(2) { color: #d47a25; background: #fff2df; }.question-params text:nth-child(3) { color: #6949df; background: #f0edff; }.question-params text:nth-child(4) { color: #1a9a7b; background: #e8f7f1; }.question-stem { display: block; margin: 22rpx 0 24rpx; color: #1c2d44; font-size: 29rpx; line-height: 1.65; font-weight: 850; }.options { display: flex; flex-direction: column; gap: 12rpx; }.option { display: flex; align-items: center; gap: 12rpx; min-height: 72rpx; padding: 14rpx 15rpx; background: #fff; border: 2rpx solid #e0e6ef; border-radius: 11rpx; }.option.selected { background: #eef3ff; border-color: #7c9cf0; }.option.correct { background: #ebf8f3; border-color: #59af98; }.option.wrong { background: #fff0ef; border-color: #dc7579; }.option-letter { width: 42rpx; height: 42rpx; display: flex; align-items: center; justify-content: center; flex: none; color: #62738a; background: #edf1f6; border-radius: 50%; font-size: 19rpx; font-weight: 900; }.selected .option-letter { color: #fff; background: #3569e8; }.correct .option-letter { color: #fff; background: #1a9a7b; }.wrong .option-letter { color: #fff; background: #d45d63; }.option-text { flex: 1; color: #30425c; font-size: 22rpx; line-height: 1.55; }.submit-button { width: 100%; height: 56rpx; line-height: 56rpx; margin: 18rpx 0 0; color: #fff; background: #3569e8; border-radius: 9rpx; font-size: 21rpx; font-weight: 850; }.submit-button[disabled] { opacity: .45; }.submit-button::after { display: none; }.analysis-card { margin-top: 19rpx; padding: 17rpx; background: #fff; border: 1rpx solid #dfe6f0; border-top: 5rpx solid #1a9a7b; border-radius: 12rpx; }.analysis-card.wrong { border-top-color: #d45d63; }.result-line { display: flex; align-items: center; gap: 10rpx; }.result-icon { width: 39rpx; height: 39rpx; display: flex; align-items: center; justify-content: center; flex: none; background: #e8f7f1; border-radius: 50%; }.wrong .result-icon { background: #fff0ef; }.result-line>view:last-child { display: flex; flex-direction: column; gap: 3rpx; }.result-line>view:last-child text:first-child { color: #1a9a7b; font-size: 21rpx; font-weight: 900; }.wrong .result-line>view:last-child text:first-child { color: #d45d63; }.result-line>view:last-child text:last-child { color: #6f7e91; font-size: 17rpx; }.analysis-content { margin-top: 15rpx; padding-top: 14rpx; border-top: 1rpx solid #e9edf3; }.analysis-title { display: block; color: #263953; font-size: 21rpx; font-weight: 850; }.analysis-text { display: block; margin-top: 8rpx; color: #53657c; font-size: 21rpx; line-height: 1.75; }.note-action { width: 100%; height: 62rpx; display: flex; align-items: center; justify-content: center; gap: 8rpx; margin: 16rpx 0 0; padding: 0; color: #6548ca; background: #f0edff; border: 1rpx solid #ddd5ff; border-radius: 9rpx; font-size: 22rpx; font-weight: 800; }.note-action::after { display: none; }.knowledge-link { display: flex; align-items: center; justify-content: space-between; gap: 8rpx; margin-top: 12rpx; padding: 12rpx; background: #edf3ff; border-radius: 8rpx; }.knowledge-link>view { display: flex; flex: 1; min-width: 0; flex-direction: column; gap: 3rpx; }.knowledge-link text:first-child { color: #3569e8; font-size: 17rpx; font-weight: 800; }.knowledge-link text:last-child { overflow: hidden; color: #40536d; font-size: 19rpx; text-overflow: ellipsis; white-space: nowrap; }.recite-card { margin-top: 17rpx; padding: 19rpx; background: #fff; border: 1rpx solid #dfd9fa; border-top: 5rpx solid #7655df; border-radius: 13rpx; }.recite-label { display: flex; align-items: center; gap: 6rpx; color: #6949df; font-size: 19rpx; font-weight: 850; }.recite-card .question-stem { margin-bottom: 18rpx; }.blank-area { display: flex; flex-direction: column; gap: 10rpx; }.blank-area text { padding: 15rpx; color: #9b91ba; background: #f6f3ff; border: 2rpx dashed #cfc5f5; border-radius: 9rpx; font-size: 19rpx; text-align: center; }.reveal-button { width: 100%; height: 54rpx; line-height: 54rpx; margin: 19rpx 0 0; color: #fff; background: #7655df; border-radius: 9rpx; font-size: 19rpx; font-weight: 850; }.reveal-button::after { display: none; }.recite-answer { margin-top: 18rpx; padding-top: 16rpx; border-top: 1rpx solid #ece7fb; }.recite-answer>text { display: block; }.recite-answer>text:first-child { color: #6949df; font-size: 19rpx; font-weight: 850; }.recite-answer>text:nth-child(2) { margin-top: 8rpx; color: #263953; font-size: 22rpx; line-height: 1.6; font-weight: 800; }.recite-answer>text:nth-child(3) { margin-top: 9rpx; color: #66768b; font-size: 19rpx; line-height: 1.65; }.recite-actions { display: flex; gap: 9rpx; margin-top: 17rpx; }.recite-actions button { flex: 1; height: 51rpx; line-height: 51rpx; margin: 0; color: #b56929; background: #fff2df; border-radius: 8rpx; font-size: 19rpx; font-weight: 800; }.recite-actions button:last-child { color: #fff; background: #1a9a7b; }.recite-actions button::after { display: none; }.session-bottom { position: fixed; z-index: 30; left: 50%; bottom: 0; width: 100%; max-width: 430px; box-sizing: border-box; display: grid; grid-template-columns: 1fr 1.15fr 1fr; gap: 8rpx; padding: 12rpx 20px calc(12rpx + env(safe-area-inset-bottom)); transform: translateX(-50%); background: #fff; border-top: 1rpx solid #e0e6ef; box-shadow: 0 -8rpx 24rpx rgba(36,54,79,.1); }.session-bottom button { height: 58rpx; display: flex; align-items: center; justify-content: center; gap: 4rpx; margin: 0; padding: 0; color: #526783; background: #f2f5f9; border-radius: 8rpx; font-size: 19rpx; }.session-bottom .card-button { color: #fff; background: #3569e8; font-weight: 850; }.session-bottom button::after { display: none; }.session-bottom button[disabled] { color: #b5beca; opacity: .55; }.drawer-mask { position: fixed; z-index: 60; inset: 0; display: flex; align-items: flex-end; justify-content: center; background: rgba(18,29,50,.46); }.answer-drawer,.note-drawer { width: 100%; max-width: 430px; max-height: 77vh; box-sizing: border-box; padding: 10rpx 20px calc(18rpx + env(safe-area-inset-bottom)); background: #fff; border-radius: 17rpx 17rpx 0 0; box-shadow: 0 -16rpx 38rpx rgba(23,36,62,.18); }.drawer-handle { width: 48rpx; height: 6rpx; margin: 0 auto 14rpx; background: #d6dce5; border-radius: 6rpx; }.drawer-head,.note-head { display: flex; align-items: center; justify-content: space-between; }.drawer-head>view { display: flex; flex-direction: column; gap: 3rpx; }.drawer-head>view text:first-child,.note-head>text { color: #1f3149; font-size: 25rpx; font-weight: 900; }.drawer-head>view text:last-child { color: #8b96a5; font-size: 17rpx; }.drawer-head button,.note-head button { width: 39rpx; height: 39rpx; display: flex; align-items: center; justify-content: center; margin: 0; padding: 0; background: #f1f4f8; border-radius: 50%; }.drawer-head button::after,.note-head button::after { display: none; }.answer-stats { display: flex; align-items: center; gap: 15rpx; margin-top: 17rpx; color: #68788e; font-size: 17rpx; }.answer-stats>view:not(.accuracy) { display: flex; align-items: center; gap: 4rpx; }.accuracy { display: flex; flex-direction: column; margin-right: auto; }.accuracy text:first-child { color: #1f3149; font-size: 32rpx; line-height: 1; font-weight: 900; }.accuracy text:last-child { margin-top: 3rpx; color: #8a96a5; font-size: 15rpx; }.green-dot,.red-dot,.gray-dot { width: 9rpx; height: 9rpx; border-radius: 50%; }.green-dot { background: #35b58c; }.red-dot { background: #e26f74; }.gray-dot { background: #c8ced8; }.drawer-progress { height: 7rpx; margin-top: 13rpx; overflow: hidden; background: #e7ecf3; border-radius: 7rpx; }.drawer-progress view { height: 100%; background: linear-gradient(90deg,#3569e8,#1a9a7b); border-radius: 7rpx; }.card-filters { display: flex; gap: 7rpx; margin-top: 15rpx; }.card-filters text { flex: 1; padding: 8rpx 2rpx; color: #75849a; background: #f2f4f8; border-radius: 7rpx; font-size: 15rpx; text-align: center; }.card-filters text.active { color: #3569e8; background: #eaf0ff; font-weight: 800; }.number-scroll { max-height: 45vh; margin-top: 17rpx; }.number-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 14rpx; padding: 2rpx 1rpx 12rpx; }.number-item { position: relative; aspect-ratio: 1; display: flex; align-items: center; justify-content: center; color: #8793a3; background: #f0f2f5; border: 3rpx solid transparent; border-radius: 50%; font-size: 19rpx; font-weight: 800; }.number-item.correct { color: #1a9a7b; background: #e5f7f0; }.number-item.wrong { color: #d45d63; background: #fff0ef; }.number-item.current { border-color: #3569e8; box-shadow: 0 0 0 4rpx #e8eeff; }.number-item uni-icons { position: absolute; right: -2rpx; top: -4rpx; }.filter-empty { padding: 38rpx 0; color: #9aa5b4; font-size: 17rpx; text-align: center; }.note-drawer { padding-bottom: calc(20rpx + env(safe-area-inset-bottom)); }.note-question { display: block; overflow: hidden; margin-top: 14rpx; color: #53657c; font-size: 17rpx; line-height: 1.5; white-space: nowrap; text-overflow: ellipsis; }.note-drawer textarea { width: 100%; min-height: 190rpx; box-sizing: border-box; margin-top: 13rpx; padding: 13rpx; color: #30425c; background: #f8fafd; border: 1rpx solid #dfe6f0; border-radius: 9rpx; font-size: 21rpx; line-height: 1.6; }.note-placeholder { color: #9ea9b8; }.note-foot { display: flex; align-items: center; justify-content: space-between; margin-top: 11rpx; color: #9aa5b4; font-size: 17rpx; }.note-foot button { width: 116rpx; height: 43rpx; line-height: 43rpx; margin: 0; padding: 0; color: #fff; background: #3569e8; border-radius: 7rpx; font-size: 17rpx; font-weight: 800; }.note-foot button::after { display: none; }
...
.knowledge-float .knowledge-link text:first-child { font-size: 17rpx; }
.knowledge-float .knowledge-title { font-size: 22rpx !important; line-height: 1.45; }
...
.completion-title { margin-top: 14rpx; color: #1d3048; font-size: 27rpx; font-weight: 900; }
.completion-desc { margin-top: 8rpx; color: #718096; font-size: 18rpx; line-height: 1.6; text-align: center; }
...
.completion-stats text:first-child { color: #315bd4; font-size: 25rpx; font-weight: 900; }
.completion-stats text:last-child { margin-top: 4rpx; color: #8a96a5; font-size: 16rpx; }
.completion-primary,.completion-secondary { width: 100%; height: 54rpx; line-height: 54rpx; margin: 16rpx 0 0; padding: 0; border-radius: 8rpx; font-size: 19rpx; font-weight: 850; }
