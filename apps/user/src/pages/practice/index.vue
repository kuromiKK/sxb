...
<template>
  <view class="practice-page page safe-top">
    ...
    <view class="section-head subject-head"><view><text class="section-title">章节练习</text><text class="section-subtitle">按科目、章、节选择要练习的题目</text></view><text class="section-count">{{ selectedSubject.chapters.length }} 章</text></view>
