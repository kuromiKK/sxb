...
.plan-scope { display: flex; align-items: center; gap: 8rpx; margin-top: 11rpx; color: #7c899a; font-size: var(--sxb-text-meta); }
.plan-scope text:first-child { padding: 4rpx 7rpx; color: #5369ad; background: #edf2ff; border-radius: 5rpx; font-weight: 700; }
.practice-page { max-width: 430px; margin: 0 auto; padding-top: calc(env(safe-area-inset-top) + 24rpx); padding-bottom: 118px; background: #f5f7fb; }.practice-header { display: flex; align-items: flex-start; justify-content: space-between; gap: 14rpx; }.practice-header>view:first-child { display: flex; flex-direction: column; gap: 5rpx; }.eyebrow { color: #6949df; font-size: var(--sxb-text-meta); font-weight: 700; letter-spacing: 0; }.page-title { color: #152238; font-size: var(--sxb-text-page); line-height: 1.2; font-weight: 700; }.header-sub { color: #7b8797; font-size: var(--sxb-text-small); }.exam-badge { display: flex; align-items: flex-end; flex-direction: column; gap: 3rpx; margin-top: 7rpx; padding: 9rpx 12rpx; color: #718096; background: #fff6eb; border: 1rpx solid #f7dfbd; border-radius: 9rpx; }.exam-badge>text { font-size: var(--sxb-text-meta); }.exam-badge>view { display: flex; align-items: baseline; gap: 3rpx; color: #d47a25; }.exam-badge>view text:first-child { font-size: var(--sxb-text-title); font-weight: 700; }.exam-badge>view text:last-child { font-size: var(--sxb-text-meta); }.plan-card { margin-top: 20rpx; padding: 19rpx; background: #fff; border: 1rpx solid #dfe6f0; border-left: 6rpx solid #3569e8; border-radius: 13rpx; box-shadow: 0 9rpx 23rpx rgba(51,74,115,.05); }.plan-top { display: flex; align-items: flex-start; justify-content: space-between; }.plan-kicker { color: #526783; font-size: var(--sxb-text-small); font-weight: 700; }.plan-number { display: flex; align-items: flex-end; gap: 4rpx; margin-top: 3rpx; }.plan-number text:first-child { color: #315bd4; font-size: var(--sxb-text-display); line-height: 1; font-weight: 700; }.plan-number text:last-child { margin-bottom: 5rpx; color: #64758b; font-size: var(--sxb-text-small); }.plan-label { display: block; margin-top: 5rpx; color: #8793a2; font-size: var(--sxb-text-meta); }.plan-side { display: flex; align-items: flex-end; flex-direction: column; gap: 4rpx; color: #7a8798; font-size: var(--sxb-text-meta); }.plan-percent { color: #3569e8; font-size: var(--sxb-text-body); font-weight: 700; }.plan-track { height: 9rpx; margin: 17rpx 0 10rpx; overflow: hidden; background: #e8edf5; border-radius: 9rpx; }.plan-track view { height: 100%; background: linear-gradient(90deg,#3569e8,#7655df); border-radius: 9rpx; }.plan-foot { display: flex; align-items: center; justify-content: space-between; color: #64758b; font-size: var(--sxb-text-meta); }.plan-status { color: #1a9a7b; font-weight: 700; }.plan-actions { display: flex; align-items: center; gap: 10rpx; margin-top: 15rpx; }.primary-action { flex: 1; height: 49rpx; display: flex; align-items: center; justify-content: center; gap: 5rpx; margin: 0; padding: 0; color: #fff; background: #3569e8; border-radius: 8rpx; font-size: var(--sxb-text-small); font-weight: 700; }.primary-action::after { display: none; }.text-action { width: 100rpx; height: 49rpx; line-height: 49rpx; margin: 0; padding: 0; color: #3569e8; background: #eef3ff; border-radius: 8rpx; font-size: var(--sxb-text-meta); }.text-action::after { display: none; }.weak-card { display: flex; align-items: center; gap: 11rpx; margin-top: 16rpx; padding: 15rpx; background: #fff8ef; border: 1rpx solid #f6dfbd; border-radius: 12rpx; }.weak-icon { width: 47rpx; height: 47rpx; display: flex; align-items: center; justify-content: center; flex: none; background: #ffebd2; border-radius: 13rpx; }.weak-copy { display: flex; flex: 1; min-width: 0; flex-direction: column; gap: 3rpx; }.weak-title { color: #a75c20; font-size: var(--sxb-text-body); font-weight: 700; }.weak-desc { color: #6f6870; font-size: var(--sxb-text-meta); line-height: 1.35; }.weak-meta { color: #cf7b2d; font-size: var(--sxb-text-meta); }.section-head { display: flex; align-items: flex-end; justify-content: space-between; gap: 10rpx; margin: 24rpx 0 12rpx; }.section-head>view { display: flex; flex-direction: column; gap: 4rpx; }.section-title { color: #152238; font-size: var(--sxb-text-item); font-weight: 700; }.section-subtitle { color: #7b8797; font-size: var(--sxb-text-meta); }.section-count { color: #6c5bc5; font-size: var(--sxb-text-meta); font-weight: 700; }.tool-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 8rpx; }.tool-item { display: flex; align-items: center; flex-direction: column; gap: 5rpx; min-height: 114rpx; padding: 13rpx 5rpx 10rpx; background: #fff; border: 1rpx solid #e1e7f0; border-radius: 11rpx; }.tool-icon { width: 43rpx; height: 43rpx; display: flex; align-items: center; justify-content: center; border-radius: 12rpx; }.tool-icon.wrong { background: #fff0e5; }.tool-icon.favorite { background: #f0ecff; }.tool-icon.note { background: #e9efff; }.tool-icon.recite { background: #e7f7f1; }.tool-title { color: #263953; font-size: var(--sxb-text-small); font-weight: 700; }.tool-meta { overflow: hidden; width: 100%; color: #8a96a5; font-size: var(--sxb-text-meta); text-align: center; text-overflow: ellipsis; white-space: nowrap; }.subject-head { margin-top: 25rpx; }.subject-tabs { display: flex; flex-wrap: wrap; gap: 8rpx; }.subject-tab { display: flex; align-items: center; gap: 4rpx; min-height: 43rpx; padding: 0 11rpx; color: #536987; background: #fff; border: 1rpx solid #dce4ef; border-radius: 8rpx; font-size: var(--sxb-text-meta); }.subject-tab.active { color: #fff; background: linear-gradient(100deg,#3569e8,#6949df); border-color: transparent; }.subject-overview { display: flex; align-items: center; justify-content: space-between; margin-top: 13rpx; padding: 14rpx 15rpx; background: #eef3ff; border: 1rpx solid #dbe6ff; border-radius: 11rpx; }.overview-name { display: block; color: #253855; font-size: var(--sxb-text-small); font-weight: 700; }.overview-meta { display: block; margin-top: 4rpx; color: #718197; font-size: var(--sxb-text-meta); }.overview-ring { width: 50rpx; height: 50rpx; display: flex; align-items: center; justify-content: center; color: #3569e8; border: 5rpx solid #8faeff; border-radius: 50%; font-size: var(--sxb-text-meta); font-weight: 700; }.chapter-list { display: flex; flex-direction: column; gap: 10rpx; margin-top: 12rpx; }.chapter-card { overflow: hidden; background: #fff; border: 1rpx solid #dfe6f0; border-radius: 11rpx; }.chapter-head { display: flex; align-items: center; justify-content: space-between; gap: 8rpx; padding: 16rpx 14rpx; }.chapter-name { display: flex; align-items: baseline; gap: 8rpx; min-width: 0; }.chapter-name text:first-child { flex: none; color: #3569e8; font-size: var(--sxb-text-meta); font-weight: 700; }.chapter-name text:last-child { overflow: hidden; color: #263953; font-size: var(--sxb-text-body); font-weight: 700; text-overflow: ellipsis; white-space: nowrap; }.chapter-count { display: flex; align-items: center; gap: 5rpx; flex: none; color: #8995a5; font-size: var(--sxb-text-meta); }.section-list { padding: 0 13rpx 10rpx; border-top: 1rpx solid #eef1f5; }.section-row { display: flex; align-items: center; gap: 9rpx; padding: 13rpx 2rpx; border-bottom: 1rpx solid #eef1f5; }.section-row:last-child { border-bottom: 0; }.section-copy { flex: 1; min-width: 0; }.section-name { display: flex; align-items: baseline; gap: 7rpx; }.section-name text:first-child { flex: none; color: #6949df; font-size: var(--sxb-text-meta); font-weight: 700; }.section-name text:last-child { overflow: hidden; color: #30425c; font-size: var(--sxb-text-small); line-height: 1.45; text-overflow: ellipsis; white-space: nowrap; }.section-meta { display: flex; gap: 10rpx; margin-top: 5rpx; color: #7f8da1; font-size: var(--sxb-text-meta); }.section-progress { width: 5rpx; height: 42rpx; overflow: hidden; flex: none; background: #e8edf4; border-radius: 5rpx; transform: rotate(180deg); }.section-progress view { width: 100%; background: #3569e8; border-radius: 5rpx; }.section-row>uni-icons { flex: none; }
.header-sub { font-size: var(--sxb-text-body); }
.exam-badge > text,
.exam-badge > view text:last-child { font-size: var(--sxb-text-small); }
.plan-card { border-left: 1rpx solid #dfe6f0; }
.plan-kicker { font-size: var(--sxb-text-body); }
.plan-number text:last-child { font-size: var(--sxb-text-body); }
.plan-label { font-size: var(--sxb-text-body); }
.plan-side { font-size: var(--sxb-text-body); }
.plan-percent { font-size: var(--sxb-text-title); }
.plan-foot { font-size: var(--sxb-text-body); }
.primary-action { height: 54rpx; font-size: var(--sxb-text-body); }
.text-action { width: 112rpx; height: 54rpx; line-height: 54rpx; font-size: var(--sxb-text-body); }
.weak-card { padding: 18rpx 16rpx; }
.weak-title { font-size: var(--sxb-text-body); }
.weak-desc { font-size: var(--sxb-text-body); line-height: 1.5; }
.weak-meta { font-size: var(--sxb-text-small); }
...
.tool-title { font-size: var(--sxb-text-body); }
...
.tool-meta { font-size: var(--sxb-text-meta); }
.subject-head { margin-top: 30rpx; }
.section-title { font-size: var(--sxb-text-title); }
.section-subtitle { font-size: var(--sxb-text-body); line-height: 1.45; }
.section-count { font-size: var(--sxb-text-body); }
.subject-tab { min-height: 49rpx; font-size: var(--sxb-text-small); }
.subject-overview { padding: 17rpx; }
.overview-name { font-size: var(--sxb-text-body); }
.overview-meta { font-size: var(--sxb-text-small); }
.overview-ring { width: 56rpx; height: 56rpx; font-size: var(--sxb-text-meta); }
.chapter-head { padding: 19rpx 15rpx; }
.chapter-name text:first-child { font-size: var(--sxb-text-small); }
.chapter-name text:last-child { font-size: var(--sxb-text-body); }
.chapter-count { font-size: var(--sxb-text-small); }
.section-row { padding: 17rpx 2rpx; }
.section-name text:first-child { font-size: var(--sxb-text-small); }
.section-name text:last-child { font-size: var(--sxb-text-body); }
.section-meta { margin-top: 7rpx; font-size: var(--sxb-text-small); }
