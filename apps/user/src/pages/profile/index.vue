...
.profile-page { max-width:430px; min-height:100vh; margin:0 auto; padding-top:calc(env(safe-area-inset-top) + 28rpx); padding-bottom:108px; background:#f5f7fb; }.profile-header { display:flex; align-items:flex-start; justify-content:space-between; }.identity { display:flex; flex-direction:column; }.welcome { color:#77869a; font-size:20rpx; }.nickname { margin-top:2rpx; color:#152238; font-size:36rpx; line-height:1.35; font-weight:900; }.identity-meta { margin-top:5rpx; color:#8490a0; font-size:19rpx; }.security-button { width:52rpx; height:52rpx; display:flex; align-items:center; justify-content:center; margin:3rpx 0 0; padding:0; background:#fff; border:1rpx solid #e1e7f0; border-radius:13rpx; }.security-button::after { display:none; }.exam-band { display:flex; align-items:center; justify-content:space-between; gap:12rpx; margin-top:24rpx; padding:19rpx; background:#fff; border:1rpx solid #dfe6f0; border-radius:12rpx; }.exam-band>view:first-child { display:flex; flex:1; min-width:0; flex-direction:column; gap:4rpx; }.band-label { color:#8995a5; font-size:17rpx; }.exam-name { overflow:hidden; color:#243650; font-size:24rpx; font-weight:850; text-overflow:ellipsis; white-space:nowrap; }.exam-meta { color:#7b8797; font-size:18rpx; }.exam-action { display:flex; align-items:center; gap:2rpx; color:#3569e8; font-size:19rpx; font-weight:800; }.rights-band { display:flex; align-items:center; gap:12rpx; margin-top:12rpx; padding:16rpx 18rpx; color:#fff; background:linear-gradient(105deg,#315fda,#6952ce); border-radius:12rpx; box-shadow:0 10rpx 23rpx rgba(68,79,187,.17); }.rights-icon { width:43rpx; height:43rpx; display:flex; align-items:center; justify-content:center; flex:none; background:rgba(255,255,255,.16); border-radius:11rpx; }.rights-copy { display:flex; flex:1; min-width:0; flex-direction:column; gap:4rpx; }.rights-copy text:first-child { font-size:23rpx; font-weight:850; }.rights-copy text:last-child { overflow:hidden; color:#dbe1ff; font-size:17rpx; text-overflow:ellipsis; white-space:nowrap; }.data-strip { display:grid; grid-template-columns:repeat(4,1fr); margin-top:14rpx; padding:15rpx 4rpx; background:#fff; border:1rpx solid #e6eaf0; border-radius:10rpx; box-shadow:none; }.data-strip view { display:flex; align-items:center; flex-direction:column; gap:5rpx; border-right:1rpx solid #edf0f5; }.data-strip view:last-child { border-right:0; }.data-strip text:first-child { color:#243650; font-size:27rpx; font-weight:900; }.data-strip text:last-child { color:#8692a2; font-size:16rpx; }.section-head { margin:26rpx 0 12rpx; }.section-head text { color:#152238; font-size:25rpx; font-weight:850; }.learning-grid { display:grid; grid-template-columns:repeat(4,1fr); gap:0; padding:10rpx 0; background:#fff; border:1rpx solid #e6eaf0; border-radius:10rpx; }.learning-item { min-width:0; display:flex; align-items:center; flex-direction:column; padding:10rpx 4rpx; background:transparent; border:0; border-right:1rpx solid #edf0f5; border-radius:0; }.learning-item:last-child { border-right:0; }.feature-icon { width:43rpx; height:43rpx; display:flex; align-items:center; justify-content:center; margin-bottom:8rpx; border-radius:11rpx; }.feature-icon.report { background:#e7f7f1; }.feature-icon.wrong { background:#fff0e5; }.feature-icon.favorite { background:#f0ecff; }.feature-icon.note { background:#e7f7f1; }.learning-item>text:nth-child(2) { color:#263953; font-size:19rpx; font-weight:800; }.learning-item>text:last-child { overflow:hidden; width:100%; margin-top:4rpx; color:#8a96a5; font-size:15rpx; text-align:center; text-overflow:ellipsis; white-space:nowrap; }.menu-group { margin-top:13rpx; padding:0 17rpx; background:#fff; border:1rpx solid #e0e6f0; border-radius:12rpx; }.menu-group.compact { margin-top:0; }.menu-row { display:flex; align-items:center; gap:12rpx; min-height:76rpx; border-bottom:1rpx solid #edf0f5; }.menu-row:last-child { border-bottom:0; }.menu-icon { width:42rpx; height:42rpx; display:flex; align-items:center; justify-content:center; flex:none; color:#5f748b; background:#eef2f6; border-radius:10rpx; }.menu-copy { display:flex; flex:1; min-width:0; flex-direction:column; gap:4rpx; }.menu-copy text:first-child { color:#25364d; font-size:21rpx; font-weight:800; }.menu-copy text:last-child { overflow:hidden; color:#7f8da0; font-size:18rpx; text-overflow:ellipsis; white-space:nowrap; }.unread-dot { width:9rpx; height:9rpx; flex:none; background:#e45e64; border-radius:50%; }.logout-button { width:auto; height:52rpx; line-height:52rpx; margin:20rpx auto 0; padding:0 28rpx; color:#b45a60; background:transparent; border:0; border-radius:0; font-size:19rpx; font-weight:750; }.logout-button::after { display:none; }.modal-mask { position:fixed; z-index:80; inset:0; display:flex; align-items:center; justify-content:center; padding:26px; background:rgba(20,31,51,.48); }.service-modal { width:100%; max-width:350px; box-sizing:border-box; display:flex; align-items:center; flex-direction:column; padding:24rpx; background:#fff; border-radius:15rpx; box-shadow:0 20rpx 46rpx rgba(22,37,64,.2); }.service-mark { width:62rpx; height:62rpx; display:flex; align-items:center; justify-content:center; background:#1a9a7b; border-radius:17rpx; }.service-title { margin-top:14rpx; color:#22354d; font-size:26rpx; font-weight:900; }.service-time { margin-top:5rpx; color:#8b96a5; font-size:18rpx; }.wechat-row { width:100%; box-sizing:border-box; display:flex; align-items:center; justify-content:space-between; margin-top:18rpx; padding:14rpx 16rpx; background:#f3f7f6; border-radius:9rpx; }.wechat-row text:first-child { color:#728197; font-size:18rpx; }.wechat-row text:last-child { color:#1a806a; font-size:21rpx; font-weight:850; }.copy-button,.cancel-button { width:100%; height:58rpx; line-height:58rpx; margin:15rpx 0 0; padding:0; border-radius:9rpx; font-size:20rpx; }.copy-button { color:#fff; background:#1a9a7b; font-weight:800; }.cancel-button { margin-top:8rpx; color:#718096; background:#f1f3f6; }.copy-button::after,.cancel-button::after { display:none; }
...
.tools-card .learning-item>text { font-size:20rpx; }
