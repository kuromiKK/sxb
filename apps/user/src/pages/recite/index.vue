...
.header-copy text:first-child { color:#fff7e5; font-size:28rpx; font-weight:900; }
.header-copy text:last-child { color:#cbd3e7; font-size:18rpx; line-height:1.45; }
...
.header-count text:first-child { color:#f2c76e; font-size:38rpx; line-height:1; font-weight:900; }
.header-count text:last-child { color:#cbd3e7; font-size:16rpx; white-space:nowrap; }
.subject-tabs { width:100%; margin-top:18rpx; white-space:nowrap; }
.subject-tabs-inner { display:inline-flex; gap:9rpx; min-width:100%; }
.subject-tab { min-height:48rpx; display:flex; align-items:center; justify-content:center; box-sizing:border-box; padding:0 16rpx; color:#536987; background:#fff; border:1rpx solid #dce4ef; border-radius:8rpx; font-size:20rpx; font-weight:800; }
...
.chapter-head text:first-child { flex:none; color:#3e568e; font-size:19rpx; font-weight:850; }
.chapter-head text:last-child { overflow:hidden; color:#24364f; font-size:22rpx; font-weight:850; text-overflow:ellipsis; white-space:nowrap; }
...
.section-head text:first-child { flex:none; color:#5a6599; font-size:18rpx; font-weight:850; }
.section-head text:last-child { overflow:hidden; color:#30425c; font-size:21rpx; font-weight:800; text-overflow:ellipsis; white-space:nowrap; }
...
.point-title { display:block; color:#24364f; font-size:21rpx; line-height:1.55; }
.point-meta { display:flex; align-items:center; gap:8rpx; margin-top:9rpx; }
.star-tag { display:inline-block; margin-top:9rpx; padding:3rpx 8rpx; border-radius:5rpx; font-size:17rpx; line-height:1.3; font-weight:850; }
.point-meta .star-tag { margin-top:0; }
.recent-tag { padding:3rpx 8rpx; color:#596887; background:#edf0f7; border-radius:5rpx; font-size:16rpx; line-height:1.3; }
