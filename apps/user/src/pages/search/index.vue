...
<style lang="scss">
.search-page{min-height:100vh;background:#f5f7fb;padding:36rpx 32rpx;}.search-head{display:flex;align-items:center;gap:14rpx;}.back{width:54rpx;height:54rpx;display:flex;align-items:center;justify-content:center;flex:none;background:#e9efff;border-radius:14rpx;}.search-input{height:76rpx;flex:1;display:flex;align-items:center;gap:12rpx;padding:0 18rpx;background:#fff;border:1rpx solid #e1e7f1;border-radius:13rpx;box-shadow:0 6rpx 18rpx rgba(40,58,91,.04);}.search-input input{height:76rpx;flex:1;color:#25344b;font-size: 22rpx;}.search-input>text{font-size: 32rpx;color:#96a1aa;}.tabs{display:flex;gap:32rpx;border-bottom:1rpx solid #e4e9f1;margin-top:27rpx;}.tabs text{padding:0 0 17rpx;color:#8c98a5;font-size: 22rpx;position:relative;}.tabs text.active{color:#3569e8;font-weight:800;}.tabs text.active:after{content:"";position:absolute;height:5rpx;background:linear-gradient(90deg,#3569e8,#7655df);bottom:-1rpx;left:4rpx;right:4rpx;border-radius:5rpx;}.results{display:flex;flex-direction:column;margin-top:8rpx;background:#fff;border:1rpx solid #e3e8f1;border-radius:12rpx;padding:0 18rpx;}.result{display:flex;align-items:center;gap:16rpx;padding:24rpx 0;border-bottom:1rpx solid #edf0f2;}.result:last-child{border-bottom:0;}.result-icon{width:58rpx;height:58rpx;border-radius:14rpx;display:flex;align-items:center;justify-content:center;font-size: 22rpx;font-weight:800;flex:none;}.course{background:#e9efff;color:#3569e8;}.knowledge{background:#f0ecff;color:#7655df;}.article{background:#fff0e5;color:#d9782f;}.result-copy{flex:1;min-width:0;display:flex;flex-direction:column;gap:8rpx;}.result-title{display:flex;align-items:center;gap:10rpx;}.result-title>text:first-child{font-size: 27rpx;font-weight:750;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.result-tag{font-size: 19rpx;padding:4rpx 8rpx;border-radius:5rpx;flex:none;}.course-tag{color:#3569e8;background:#e9efff;}.knowledge-tag{color:#7655df;background:#f0ecff;}.article-tag{color:#d9782f;background:#fff0e5;}.result-desc{font-size: 21rpx;color:#8995a1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}.arrow{font-size: 38rpx;color:#a1abb4;}.empty{text-align:center;color:#9ca6ae;font-size: 25rpx;padding:110rpx 0;background:transparent;border:0;}
</style>
